...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Nguyen Dang Trong Thai/NDTTBluetooth'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Nguyen Dang Trong Thai' => 'nguyendangtrongthai25@gmail.com' }
  s.source           = { :git => 'https://github.com/Nguyen Dang Trong Thai/NDTTBluetooth.git', :tag => s.version.to_s }
